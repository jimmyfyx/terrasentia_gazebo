  ...
  // Load the controller
     void GazeboRosEncoder::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf){
          ...
          * ======================================= */
          ...
          enc_publisher_ = _nh->advertise<terra_description::TerraEncoder>(enc_topic_, 1);
     ...
     void GazeboRosEncoder::UpdateChild(){
          ...
          if(seconds_since_last_update > update_period_){
               ...
               // ROS_INFO_NAMED("sim_encoder", "Wheel Position [radians]: %.4f, %.4f, %.4f, %.4f", posi[0],posi[1],posi[2],posi[3]);
