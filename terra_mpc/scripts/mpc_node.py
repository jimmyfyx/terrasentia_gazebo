...
class MPC_NODE:
    def __init__(self):
        ...
        twist_topic = rospy.get_param('/terrasentia/mpc2_node/twist_topic_name')
        wp_topic    = rospy.get_param('/terrasentia/mpc2_node/wp_topic_name')
    ...
    def updateParams(self, name):
        ...
        self.params['verbose']                          = rospy.get_param(name + '/verbose', False)
        return True
...
if __name__ == '__main__':
    ...
    # get the file path for terrasentia_gazebo
    package_path = rospack.get_path('terra_mpc')

    yaml_file_path = package_path + '/configs/mpc.yaml'
